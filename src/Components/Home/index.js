        ...
        <>
            ...
            <div className="bg-secondary h-auto">
                    ...
                    <div className="grid grid-cols-3 gap-4 place-items-center">
                        ...
                        <div className="bg-neon-yellow w-72 h-72 text-center rounded-xl hover:scale-105">
                            <h1 className="text-lg pt-2"> Personal Portfolio </h1>
                        </div>
                        <div className="bg-neon-yellow w-72 h-72 mr-32 text-center rounded-xl hover:scale-105">
                            <h1 className="text-lg pt-2"> FIFA Career Mode Stat Tracker </h1>
                        </div>
                        <div className="bg-neon-yellow w-72 h-72 mb-64 mt-10 ml-32 text-center rounded-xl hover:scale-105">
